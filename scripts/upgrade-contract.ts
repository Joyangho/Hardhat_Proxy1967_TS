...
async function main() {
  ...
  const HighRunTokenV3 = await ethers.getContractFactory("HighRunTokenV3");
  console.log("Upgrading HighRunTokenV1 -> HighRunTokenV2 ...");

  await upgrades.upgradeProxy(contractAddress, HighRunTokenV3);
  console.log("HighRunTokenV3 upgraded");
}
